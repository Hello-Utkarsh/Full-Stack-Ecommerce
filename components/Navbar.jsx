        ...
        {cookie ? <div className='flex justify-end items-center w-44 mr-4'>
          ...
          <Link href={"/shop/login"} className='mx-auto'>
            <motion.button
              ...
              className="cursor-pointer text-lg text-[#241834] bg-[#E4E2EA] font-medium rounded-lg w-fit px-3 py-2 mx-auto max-md:text-base">Login</motion.button>
          </Link>
          <Link href={"/shop/signin"} className='mx-auto'>
            <motion.button
              whileHover={{ scale: 1.1 }}
              transition={{ type: "spring", stiffness: 400, damping: 20 }}
              className="cursor-pointer text-lg text-[#241834] bg-[#E4E2EA] font-medium rounded-lg w-fit px-3 py-2 mx-auto max-md:text-base">SignIn</motion.button>
          </Link>
        </div>}
